...
if START_IMG is None:
    img = "https://telegra.ph/file/063fa55873d177e714d04.jpg"
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="Help",callback_data="help_back"),InlineKeyboardButton(text="🔋Creator",url="https://t.me/rosebakthan")]]
    keyboard += [[InlineKeyboardButton(text="Connect Group", callback_data="main_connect"),InlineKeyboardButton(text="SOURCE",url="https://t.me/joinchat/WCAe3d8Ou71LTErh"),InlineKeyboardButton(text="Add Me🔌",url="t.me/{}?startgroup=true".format(bot.username))]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="©️ made by",url="https://t.me/rosebakthan")]]))
        return
